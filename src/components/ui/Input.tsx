  ...
  return (
    <div className="mb-2 w-full space-y-2">
      {label && (
        <label
          htmlFor={name}
          className="text-base text-left font-normal mb-3 text-[#232948]"
        >
          {label}
        </label>
      )}
      <div
        className={cn(
          "flex items-center gap-3 w-full  py-2 border border-[#9096b1] rounded-lg",
          error ? "border-red-500" : "border-[#9096b1]",
          className
        )}
      >
